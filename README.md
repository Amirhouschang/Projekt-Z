...
👉 For the full English version of the technical project overview, please scroll down below or switch to the [README_en.md](./README_en.md).
...
![Portfolio-Wert vs. Investiert](./01_ETF_Investment_vs_CurrentValue.png)  
...
**Visualizations:**
- ![Investment Table](./01_Investment_Table.png)  
  *Structured list of ETFs, ISINs, and asset types*
...
- **Excel**  
  Used for structured tracking, automated calculations, and neutral visualizations.

- **GitHub**  
  For transparent documentation and development of future analytics features.

- **Manual Data Collection**  
  Data from Bitvavo, Scalable Capital, Trade Republic  
  Includes staking rewards, prices, IDs, and platform logs

- **Learning & Reflection Tools**  
  Podcasts, financial blogs, and AI support via ChatGPT

---

### Next Steps

- Time series tracking and monthly performance monitoring  
- Visual dashboards using Power BI or Python (pandas, matplotlib)  
- Rebalancing effect analysis  
- Integration of KPIs and structured decision rules

---

*This is not a simulation. It is a real-world data project based on personal financial responsibility and learning through application.*
